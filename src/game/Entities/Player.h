...
class Player : public Unit
{
    ...
    public:
        ...
        **/
        ...
        Item* StoreNewItem(ItemPosCountVec const& dest, uint32 item, bool update, int32 randomPropertyId = 0, Loot* loot = nullptr);
        ...
        void SendThreatMessageToPlayer(std::string const& message) const;
